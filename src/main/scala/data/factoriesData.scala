...
class factoryBuilder(){
  ...
  def build(typeOf : String, town : Town) = {
    typeOf match {
      case "aluminium_plan" => {new Factory(List[Stuff](new Bauxite(100),new Coal(25)),new Aluminium(100),200,town)}
      ...
      case "fruit_orchad" => {new Factory(List[Stuff](),new Fruit(100),200,town)}
      ...
      case "vehicle_factory" => {new Factory(List[Stuff](new Aluminium(100),new Electronics(100),new Glass(100),new Plastics(100),new Steel(100),new Tyres(100)),new Vehicles(100),200,town)}
      case "vineyard" => {new Factory(List[Stuff](new Glass(100)),new Wine(100),200,town)}
      case "wire_mill" => {orf(new Factory(List[Stuff](new Aluminium(100)),new AluminumWires(100),200,town),
